...
## Tropical plant hyperdiversity

In my work as Postdoc ar Aarhus University we ask the quite fundamental question why there are so many species in tropical rainforest.
...
While dozens of hypotheses have been proposed to explain the immense variation in species richness across the planet. Among those hypotheses, mechanisms involving variation in the rate of speciation and/or extinction have featured prominently. These include the Metabolic Theory of Ecology, a textbook theory conceptually linking climate and species richness. Yet we find that global patterns of plant species richness and diversification are unlinked. We reject these mechanisms for seed plants and suggest that it may be time to retire those hypotheses that explain global species richness patterns with variation in diversification rate and focus on “time for speciation” or ecological processes instead.
...
We also provide a global map of global plant species richness and diversification rates for about 330,000 species, and put several environmental factors to the test to explain these patterns.


Read the full paper here: [PNAS](https://www.pnas.org/doi/full/10.1073/pnas.2120662119)
